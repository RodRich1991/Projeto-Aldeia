    ...
    for (i=0; i<8; i++){
        ...
        for (j=0; j<8; j++){
            ...
            if(classe == "casa_preta"){
                if(i < 3){
                    $("#"+nome_casa).append("<img src='peca_preta.jpg' class='peca_preta' id='"+nome_casa.replace("casa", "peca_preta")+"'/>");
                }
                else
                if(i > 4){
                    $("#"+nome_casa).append("<img src='peca_branca.jpg' class='peca_branca' id='"+nome_casa.replace("casa", "peca_branca")+"'/>");   
                }
    ...
    if(peca_selecionada==null){
        ...
        if(peca_anterior != null){
            if (((peca_anterior.indexOf("preta") >= 0) && (nI > aI)) ||   ((peca_anterior.indexOf("branca") >= 0) && (nI < aI))){
                ...
                if((dI == 1) && (dJ == 1)){                                 $("#"+casa_anterior).remove("#"+peca_anterior);
